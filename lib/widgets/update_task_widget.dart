...
class UpdateTaskWidget extends StatefulWidget {
   UpdateTaskWidget({Key? key,required this.title,required this.dateTime,required this.category,required this.isN,required this.completed,required this.id}) : super(key: key);
   String title;
   String category;
   DateTime dateTime;
   int isN;
    ...
    return StatefulBuilder(builder: (context, categoryChanges) {
      return BlocConsumer<TodoBloc, ToDoState>(
              ...
              children: [
                ...
                ZoomTapAnimation(
                  ...
                  onTap: () {
                    ...
                    if (dateTime.day.toString().isEmpty) {
        ...
        listener: (context, state) {
          if (state is LoadInSuccessUpdated) {
            category = '';
            BlocProvider.of<TodoBloc>(context)
                .add(GetAllTasks());
